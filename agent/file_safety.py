...
# Control files (auth.json, webhook_subscriptions.json) are deliberately NOT
# here (#45947): read-denied, but the user may ask to edit them.
# Local hardening: config.yaml + SOUL.md stay write-protected — bot identity
# and org config must not be agent-writable.
_HERMES_PROTECTED_SUBPATHS = (
    "state.db", "sessions", "mcp-tokens", "pairing", "vault",
    "browser-profile", "config.yaml", "SOUL.md",
)
